...
from hrl_air_hockey.bspline_planner.utils.table import Table
...
def air_hockey_table(xyz, dt, huber):
    ...
    xlow_loss = relu_huber_along_path(table.x_min - xyz[..., 0])
    xhigh_loss = relu_huber_along_path(xyz[..., 0] - table.x_max)
    ylow_loss = relu_huber_along_path(table.y_min - xyz[..., 1])
    yhigh_loss = relu_huber_along_path(xyz[..., 1] - table.y_max)
