...
def experiment(env_name: str = 'BaseEnv',
               ...
               mode: str = 'disabled',
               horizon: int = 200,
               agent_1: str = 'Model_2020.pt',
               group: str = '000',
               gamma: float = 0.99,
               full_save: bool = False,
               termination: bool = False,
               pos_condition: bool = False,

               actor_lr: float = 3e-4,
               critic_lr: float = 3e-4,
               n_features_actor: str = '64 64 64',
               n_features_critic: str = '64 64 64',
               batch_size: int = 256,
               ...
               # check_point: str = 'logs/high_level_2024-05-07_00-52-10/check_point___.-logs-high_level_2024-05-05_16-22-46-parallel_seed___0-0-BaseEnv_2024-05-05-16-23-09/parallel_seed___2/0/BaseEnv_2024-05-07-00-52-29',
    ...
    wandb.init(project="HighLevel", dir=results_dir, config=config, name=f"{current_time}_seed{parallel_seed}",
    ...
    env = BaseEnv(horizon=horizon, gamma=0.99)
            ...
            for root, dirs, files in os.walk(parent_dir):
                for f in files:
                    if f.endswith(postfix):
                        ...
                        file_list.append(a)
            return file_list
        rl_agent = SAC.load(get_file_by_postfix(check_point, 'agent-1.msh')[0])
        rl_agent._alpha_optim = optim.Adam([rl_agent._log_alpha], lr=lr_alpha)
